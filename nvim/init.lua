    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          local builtin = vim.g.use_fzf_lua and require 'fzf-lua' or require 'telescope.builtin'
          ...
          map('<leader>D', vim.g.use_fzf_lua and builtin.lsp_typedefs or builtin.lsp_type_definitions, 'Type [D]efinition')
          ...
          map('<leader>ws', vim.g.use_fzf_lua and builtin.lsp_workspace_symbols or builtin.lsp_dynamic_workspace_symbols, '[W]orkspace [S]ymbols')
